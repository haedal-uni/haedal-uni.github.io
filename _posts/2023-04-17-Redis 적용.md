...
![image](/assets/img/posts/225282172-9034a0a4-296b-4945-a755-e189bd15a101.png){: width="50%"}

redis를 run한 다음에 

![image](/assets/img/posts/225282372-e44af89f-b7e5-4cd3-af19-12460c04abc9.png){: width="50%"}
...
![image](/assets/img/posts/232888749-92ecc5ca-126e-4d46-a92c-fc661e90af7a.png)
...
*nested exception is io.lettuce.core.RedisConnectionException: Unable to connect to localhost/<unresolved>:6379`*
...
오류 해결 👉🏻 [Docker Redis + Spring 연결](https://velog.io/@aswooo/Redis-Spring-%EC%97%B0%EA%B2%B0)                           

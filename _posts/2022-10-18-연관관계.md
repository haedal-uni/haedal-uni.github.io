...
여기 *Member*와 *Profile*로 연관관계 매핑을 해볼 것이다.  
...
#### 예시
연관관계를 공부한 후 현재 구현하고 있는 프로젝트에 적용시켰다.

Registry와 Comment는 일대 다 관계이다.
...
Registry와 Comment를 매핑 후 test 코드를 작성했다.
```java
    void commentSave() {
        ...
        System.out.println(savedRegistry);
...
Registry에 Comment 값이 담겨져 있는지 출력해보면 아래와 같이 나오게 된다.

![image](https://user-images.githubusercontent.com/74857364/201734216-2238652e-c72c-4660-bd5b-6985593dfca3.png)

다대 일, 일대 다 관계에서 일인 클래스는 위 그림처럼 값을 담을 수 없다.

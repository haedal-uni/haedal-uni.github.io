...
public class User implements UserDetails {
   ...
   public User(Long id, String email, String password, UserRole role, String nickname) {
      this.id = id;
      this.email = email;
    ...
    // 생성된 Service 객체로 부터 User를 받는다.
     ...
     // SuccessHandler가 사용할 수 있도록 등록해준다.
      ...
      User user = userRepository.findByEmail(oAuth2Attribute.getEmail()).orElseGet(() -> {
         ...
         User saved = UserMapper.toEntity(oAuth2User, encodedPassword);
...
public class OAuth2SuccessHandler implements AuthenticationSuccessHandler {
   ...
   public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws
      ...
      String token = jwtProvider.createToken(user.getNickname(), UserRole.USER.toString()); // string 으로 받는다

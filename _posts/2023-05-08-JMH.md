...
![image](https://github.com/haedal-uni/haedal-uni.github.io/assets/74857364/4515d621-c43b-48ea-b8ae-ca09033cc6cf)
...
![image](https://github.com/haedal-uni/haedal-uni.github.io/assets/74857364/cabc6c72-c0b6-4ef5-87be-9a507d14135a)
...
![image](https://github.com/haedal-uni/haedal-uni.github.io/assets/74857364/f706db1e-be2c-4b06-979b-93da54a7837b)
...
**1.** 클래스에 ex.`@State(Scope.Benchmark)` 어노테이션을 붙여 벤치마크할 상태를 지정한다.

**2.** 클래스에 ex.`@BenchmarkMode(Mode.AverageTime)` 어노테이션을 붙여 벤치마크 결과를 나타내는 모드를 설정한다.

**3.** 클래스에 ex.`@OutputTimeUnit(TimeUnit.MILLISECONDS)` 어노테이션을 붙여 결과의 시간 단위를 설정한다.

...
![image](/assets/img/posts/cab22d47-c884-4596-90e6-1bde46cfef7e.png)
...
![image1](/assets/img/posts/4c375494-3db7-4e33-bce2-46386f9fdf50.png)

test를 위해 date 대신 varchar 적용

*기존에는 날짜만 저장하기 때문에 date를 사용했지만 10분단위로 test를 해야하므로 시간까지 적용했다.

![image1](/assets/img/posts/6e7eed94-1411-49b5-9165-f2e058a666b4.png)
...
```
![image](/assets/img/posts/ec3fd426-5551-4c60-abbb-4300ba8bfe0c.png){: width="40%"}   
...
```
![image](/assets/img/posts/468359a4-2a44-4f97-9738-00d541f79e94.png){: width="40%"}    
...
![image1](/assets/img/posts/2b2c8072-2395-4498-8a64-ec5c6820110b.png)

<br><br>
           
![image1](/assets/img/posts/015ff6e3-58c0-4328-9621-92b921693dc9.png)

...
![image](/assets/img/posts/faf156f0-7f1c-4ad0-8873-2bbbfb61d509.png){: width="30%"}    

![image](/assets/img/posts/ddcabf45-2033-4148-8209-2abd7a49b156.png){: width="30%"}    
...
![image](/assets/img/posts/593a16ff-9051-4f95-858e-5ac4b82223e6.png){: width="30%"}    

- Map 활용 o + `@CachePut` : 0.018초 (17525700 나노초)           
![image](/assets/img/posts/907aa374-b95d-4044-8517-b2839eb23195.png){: width="30%"}    

- Map 활용 x + `RedisTemplate` : 0.051초 (51041600 나노초)     
![image](/assets/img/posts/8d0997d4-1c29-4942-b3c8-de7022f74ebf.png){: width="30%"}    


- Map 활용 o + `RedisTemplate` : 0.009초 (8879100 나노초)         
![image](/assets/img/posts/18a81725-5938-445b-8aaa-69246757bebe.png){: width="30%"}    

...
![image](https://github.com/user-attachments/assets/d8eb1b37-f41e-4e3a-b87b-f6ed52f2cb59)
...
![image](https://github.com/user-attachments/assets/883f02ec-10e1-4b6d-8a29-9967da104605)
...
#### front
front에서는 해당 값을 받아서 localStorage에 저장한다. 
...
localStorage.getItem(JSON.parse(localStorage.getItem(username))) // string → object로 변환 
```

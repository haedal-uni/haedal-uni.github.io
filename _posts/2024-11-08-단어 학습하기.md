...
![AC_ 20241110-001510](/assets/img/posts/dd0d8e36-ec3b-4a44-b4ff-ee2c6b5503ee.gif){: width="50%"}  
...
## DB 설계 
![image](/assets/img/posts/cbcb113b-8953-47d1-a41e-d0d9ede16f42.png)
...
![image](/assets/img/posts/d8eb1b37-f41e-4e3a-b87b-f6ed52f2cb59.png){: width="50%"}   
...
![image](/assets/img/posts/883f02ec-10e1-4b6d-8a29-9967da104605.png){: width="50%"}  
...
- `PageRequest`: 실제로 페이징 객체를 만들 때 사용하는 클래스(Pageable의 구현체)     

  - `PageRequest.of(page, 10)` : page는 조회할 페이지의 번호, 10은 한 페이지에 보여 줄 게시물의 개수
    
- `Pageable`: 페이징 정보를 담는 인터페이스

  - page 번호, size(페이지당 데이터 개수), sort

<br><br>

실행하면 아래와 같이 front에서 받게 된다.

![image](/assets/img/posts/3d946dc8-5dfd-4d1d-9d39-221d8ff01848.png)
...
- [3-02 페이징 기능 추가하기](https://devwarriorjungi.tistory.com/entry/Pageable%EA%B3%BC-PageRequest-%EA%B0%9C%EB%85%90%EA%B3%BC-%EB%B9%84%EA%B5%90)            

...
void test(){
    ...
    System.out.println("\n------------ POST에 달린 comment 내용 조회 완료 ------------\n\n");
}
```

![image](https://github.com/haedal-uni/haedal-uni.github.io/assets/74857364/b8ea951f-b391-4514-9999-a93fdde319ad){: width="50%"}
...
![image](https://github.com/haedal-uni/haedal-uni.github.io/assets/74857364/28c7021e-3d2b-4fce-a59a-16abb030a284){: width="50%"}
